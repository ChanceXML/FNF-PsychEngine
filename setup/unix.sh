...
yes | haxelib install flixel 5.6.1
yes | haxelib install flixel-addons 3.2.2
yes | haxelib install flixel-tools 1.5.1
yes | haxelib install hscript-iris 1.1.3
yes | haxelib install tjson 1.4.0
yes | haxelib install hxdiscord_rpc 1.2.4
yes | haxelib install hxvlc 2.0.1 --skip-dependencies
...
yes | haxelib git linc_luajit https://github.com/superpowers04/linc_luajit 1906c4a96f6bb6df66562b3f24c62f4c5bba14a7
