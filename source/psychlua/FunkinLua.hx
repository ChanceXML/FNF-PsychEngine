...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		try {
			...
			#if android
			var code:String = null;
			if(sys.FileSystem.exists(scriptName)) {
				code = sys.io.File.getContent(scriptName);
			} else if(openfl.utils.Assets.exists(scriptName)) {
				code = openfl.utils.Assets.getText(scriptName);
			}
